...
// Функция вывода отрезков путей, кратчайшего пути, расстояния.
...
void Graph<T>::InsertVertex(const T& vertex) {
	if (!this->IsFull()) {
		...
		cout << "Граф заполнен. Добавить вершину нельзя " << endl;
		return;
	}
}
...
Graph<int> makeGraph()
{
	...
	cout << "Введите количество вершин: "; cin >> amountVerts; cout << endl;
	cout << "Введите количество ребер: "; cin >> amountEdges; cout << endl;
...
void Graph<T>::InsertEdge(const T& vertex1, const T& vertex2, int weight) {
	if (this->GetVertPos(vertex1) != (-1) && this->GetVertPos(vertex2) != (-1)) {
		...
		cout << "Обеих вершин нет в графе или одной из них " << endl;
		return;
	}
}
...
// Функция для вычислениия текущего местоположения
